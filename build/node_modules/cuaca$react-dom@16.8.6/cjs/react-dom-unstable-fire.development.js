...
Liferay.Loader.define('cuaca$react-dom@16.8.6/cjs/react-dom-unstable-fire.development', ['module', 'exports', 'require', 'cuaca$react', 'cuaca$object-assign', 'cuaca$prop-types/checkPropTypes', 'cuaca$scheduler', 'cuaca$scheduler/tracing'], function (module, exports, require) {
  var define = undefined;

  (function () {
    'use strict';

    var React = require('cuaca$react');
    var _assign = require('cuaca$object-assign');
    var checkPropTypes = require('cuaca$prop-types/checkPropTypes');
    var scheduler = require('cuaca$scheduler');
    var tracing = require('cuaca$scheduler/tracing');
