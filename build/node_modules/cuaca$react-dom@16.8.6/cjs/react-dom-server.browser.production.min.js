...
'use strict';
Liferay.Loader.define("cuaca$react-dom@16.8.6/cjs/react-dom-server.browser.production.min", ['module', 'exports', 'require', 'cuaca$object-assign', 'cuaca$react'], function (module, exports, require) {
  var define = undefined;
  var p = require("cuaca$object-assign"),
      q = require("cuaca$react");function aa(a, b, d, c, f, e, h, g) {
    if (!a) {
